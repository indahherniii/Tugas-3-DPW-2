		 ...
		 <div class="header-right">
			 ...
			 <div class="signin">
				  ...
				  <ul>
					 ...
					 <li><a href="{{url('elogin')}}"> LOGIN</a></li>
				 </ul>			 
			 </div>
		 </div>
	 ...
	 <div class="col-md-8 fashions2">			 
			<div class="slider2">
				<ul class="rslides rslider" id="slider2">				  
				  <li><img src="{{url('public')}}/images/s2.jpg" alt=""></li>
				  <li><img src="{{url('public')}}/images/s3.jpg" alt=""></li>
				  <li><img src="{{url('public')}}/images/s4.jpg" alt=""></li>
				  <li><img src="{{url('public')}}/images/s11.jpg" alt=""></li>
				</ul>
		   </div>
	  </div> 
	<div class="col-md-4 side-bar2">
		  <div class="product-price">
			 ...
			 <div class="product-id">
				 ...
				 <a class="add" href="{{url('cart')}}">ADD TO BAG</a>
			 </div>
		 </div>
      </div>
